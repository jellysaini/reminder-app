<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sign-Up.aspx.cs" Inherits="Remind.Sign_Up" %>
...
<body class="signup-page">
    ...
    <script src="<%= this.ResolveUrl("~/Content/js/pages/examples/sign-up.js") %>"></script>
</body>
</html>
