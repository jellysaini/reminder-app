<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sign-In.aspx.cs" Inherits="Remind.Sign_In" %>
...
<body class="login-page">
    ...
    <script src="<%= this.ResolveUrl("~/Content/js/pages/examples/sign-in.js") %>"></script>
</body>
</html>
