<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Forgot-Password.aspx.cs" Inherits="Remind.Forgot_Password" %>
...
<body class="fp-page">
    ...
    <script src="<%= this.ResolveUrl("~/Content/plugins/jquery-validation/jquery.validate.js") %>"></script>

    <!-- Custom Js -->
    <script src="<%= this.ResolveUrl("~/Content/js/admin.js") %>"></script>
    <script src="<%= this.ResolveUrl("~/Content/js/pages/examples/forgot-password.js") %>"></script>
</body>
</html>
